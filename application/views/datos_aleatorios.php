...
define('DB_PASSWORD','');
define('DB_DATABASE', 'inventario2');
...
for ($i = 0; $i < 10000; $i++)
{
  ...
  $sql = "INSERT INTO invent(producto, almacen, cantidad, fecha, importe, provedor) values ('$producto', '$almacen', '$cantidad', '$fecha', '$importe', '$provedor')";
